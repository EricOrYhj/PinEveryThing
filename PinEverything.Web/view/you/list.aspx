<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="PinEverything.Web.view.you.list" %>
...
<head>
    ...
    <script src="/js/Common.js?v=0.0.9"></script>
    <script src="js/list.js?v=0.0.9"></script>
    <script type="text/javascript"
        src="http://webapi.amap.com/maps?v=1.3&key=638e916deadfc862f823942b67a01c09">
    </script>
    <script src="js/listMap.js?v=0.0.9"></script>
    <link href="css/css.css?v=0.0.9" rel="stylesheet">
    <link href="css/list.css?v=0.0.9" rel="stylesheet" />
