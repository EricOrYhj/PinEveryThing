...
<head>
    ...
    <script src="js/pub.js?v=1.0.0"></script>
        ...
        <ul>
            <li class="ownerInput">
                ...
                <div class="ownerTitle">
                    <input type="text" class="address" placeholder="吃什么" id="startPosition" runat="server" />
                </div>
            ...
            <li class="ownerInput">
                ...
                <div class="ownerTitle">
                    <input type="text" class="address" placeholder="餐厅地点" id="endPosition" runat="server" />
                </div>
                <div class="ownerArrow"></div>
            </li>
